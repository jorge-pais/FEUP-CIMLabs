...
filter = fspecial('gaussian', 10, 10);
%I = imfilter(I, filter);
...
case 2 % do split and merge    
    dim = uint8(input("What is the minimum division to apply the algorithm to? - "));
    ...
    fprintf("The number of distinct regions detected was %d\n", length(unique(segments)));
end
...
% Auxiliary function for all the command line selection prompts
